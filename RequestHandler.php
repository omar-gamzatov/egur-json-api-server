...
class RequestHandler
{
    ...
    /**
     * В зависимости от запроса полученного от клиента выполняет инструкции:
     * - на получение нового серийного номера для текущего клиента
